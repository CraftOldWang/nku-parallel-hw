...
{
    std::ofstream csv_file("matrix_performance_test.csv");

    // Write header
    csv_file << "Matrix_Size,Repeat_Times,Common_Time,Cache_Optimized_Time,Speedup\n";
...
double* matrix_common(double* vec, double* A, int N)
{
...
void test()
{
    ...
    write_results_to_csv(matrix_sizes, repeat_times, common_times, cache_times, speedups);
}
